...
2. The largest remaining duplicate-surface risk is outside canonical `repos/` governance.
   `C:/ATLAS-standalone/fitness-release-main`, `C:/ATLAS-worktrees/pr1-stack-lock-refresh`, and the Verta surfaces remain outside the intended canonical layout and need explicit later decisions.
...
- `C:/ATLAS-worktrees/remove-stale-cortex-contract-v2`
