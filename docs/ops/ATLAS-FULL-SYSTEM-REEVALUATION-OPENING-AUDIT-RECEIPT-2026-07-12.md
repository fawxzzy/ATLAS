...
```json
{
  ...
  "status": "governed_success_pending_parent_publication",
    "marker_transition": {"from": 0, "to": 50},
    ...
    "artifact_hashes": {
      "audit": "4308D5F7999D8B7592893548B675DF417E85A458E35DA3F7585D24290FB91A73",
      "lane_registry": "8A0A7331EAB70136A82B22BD6821BEBE49A4A4BD29A630BDEAC9D07769EE7607",
      "continuity_manifest": "20F0AF84FC1D2E318E5D10A9988FDD25F05CB44A3C5B6880DEC1F21D8D0AF2A2"
    },
    "primary_lane_ids": [
    ...
    "opening_validation_snapshot": {
      ...
      "info": 0,
      "errors": [
        {"code": "stack-lock-drift", "path": "stack.lock.yaml", "message": "Stack lockfile does not match the current pinned working set."},
        {"code": "stack-lock-render-drift", "path": "stack.lock.yaml", "message": "Stack lockfile bytes do not match the canonical generated lockfile payload."},
        {"code": "stack-lock-pin-drift", "path": "stack.lock.yaml#_stack", "message": "pinned component fields differ from the current generated working set: commit."},
        {"code": "stack-lock-missing-ref", "path": "stack.lock.yaml#_stack", "message": "pinned `2127af207370cacf8752fd4f13c6545ea49bb503` does not match current `_stack` HEAD `5ea6b712b91a691689b619addb8f8ba649126661`."}
      ],
      "warning_work_items": [
    ...
    "final_validation": {
      ...
      "warning": 25,
      "info": 0,
      "errors": ["working-memory-catalog-drift", "stack-lock-drift", "stack-lock-render-drift", "stack-lock-pin-drift", "stack-lock-missing-ref"],
      "warning_work_item_total": 25,
    ...
    "recovery_control": {"stashes":[{"name":"atlas-full-system-opening-audit-13-path-recovery-2026-07-12","oid":"5595299105c20b361f13653708de3030cc3fbd11","payload_count":13,"payload_verified_exact":true},{"name":"atlas-full-system-opening-audit-terra-validation-recovery-2026-07-12","oid":"5e93dad8dccab196370737413d0e7e60bc0f8cca","payload_count":13,"payload_verified_exact":true},{"name":"atlas-full-system-opening-audit-terra-semantic-recovery-2026-07-12","oid":"e9fe1190afc7468c6b52b3c642db47b3099dd070","payload_count":13,"payload_verified_exact":true}],"pop_or_drop_performed":false,"preserve_or_cleanup":"deferred until reviewed"},
    "runtime": {
    ...
    "prohibited_action_confirmations": {"owner_repo_mutation":false,"external_mutation":false,"secret_value_access":false,"discord_write":false,"supabase_write":false,"vercel_deploy_or_promotion":false,"github_cleanup":false,"branch_or_worktree_cleanup":false,"retention_action":false,"stack_lock_or_manifest_mutation":false,"runtime_source_test_or_executable_mutation":false,"root_untracked_entry_mutation":false,"manual_stage_or_commit":false,"push":false},
    "exact_next_action": "ATLAS MAIN reviews this accepted published 0->50 receipt and, if accepted, sends the explicit RESUME MAZER message to standing task 019f52e6-3b96-78b0-adb4-946b475f4ba6 from its preserved checkpoint. This audit must not send that message. Fitness remains security-blocked."
}
```
