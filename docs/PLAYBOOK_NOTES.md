...
## 2026-05-15 - Discord verification should use app-session proof and signed interactions

- Type: Pattern
- Summary: Discord access gates should consume short-lived proof generated by the source app session, and production Discord interaction handling should be signed HTTP when hosted by the app.
...
- Evidence: Fawxzzy Fitness Discord verification build, PR #20, PR #21
- Status: Proposed
