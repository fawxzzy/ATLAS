...
- external smoke and retained-surface cleanup is now decision-bounded; only the delete-now class from the 2026-05-26 Playbook/Lifeline decision packet is ready for execution
