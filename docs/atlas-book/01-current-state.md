...
- the Playbook external-smoke family opened by the 2026-05-26 decision chain is now fully consumed; the remaining closeout pressure is no longer local Playbook residue and instead sits in preview/unfurl follow-on and DiscordOS-owned downstream work
