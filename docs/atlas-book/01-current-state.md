...
- the delete-now external-smoke class from the 2026-05-26 Playbook/Lifeline decision packet is now consumed; the four one-commit Playbook proof/test branches are preserved and decision-cleared for disposal execution, while the remaining separate pressure is the stranded `smoke-home` manual-review checkout
