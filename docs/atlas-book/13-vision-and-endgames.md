...
- currently open because the durable substrate is already strong, continuity-manifest doctrine and retrieval taxonomy are explicit, the active prompt pack is normalized, and the marker can honestly ratchet into the mid-band, but retrieval-first use is still partly manual and not yet universal across all major lanes
- next valid package:
