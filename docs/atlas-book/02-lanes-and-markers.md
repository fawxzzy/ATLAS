...
- execution remains blocked until bounded rewrite and rollback order are frozen
...
- naming and ownership hygiene are durable at the policy/mapping layer, but still blocked from execution without bounded rewrite and rollback order
