...
- ATLAS root self-lock sequencing has been resolved; the next pressure is the bounded Playbook retained-surface cleanup class plus later preview/unfurl and DiscordOS follow-on lanes
