...
- ATLAS root self-lock sequencing has been resolved; the Playbook external-smoke family is closed, and the next pressure is preview/unfurl follow-on plus DiscordOS-owned downstream lanes
