...
- the exact next move after that manifest-only split is one bounded sensitivity-first packet over the secret-like/config-like and tool-state residue subset; bulk preserve, bulk stage, cleanup, or delete claims remain out of scope
