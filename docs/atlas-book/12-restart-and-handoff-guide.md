...
- the earlier six-manifest set passed a second actual refresh cycle after breadth expansion, and the seeded set has now expanded conservatively again to include Atlas-owned Repo Naming Canonicalization as a newly manifest-backed root-governed lane
