...
- the exact next move is one bounded blocker-facing classification or preservation slice for untracked `docs/ops/*` only; tracked root carry is exhausted and retained `archive/*` evidence remains out of scope
