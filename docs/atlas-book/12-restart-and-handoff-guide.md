...
- the exact next move after preserving that tranche is later classification or preservation for the two-file non-LDG colder `docs/ops/*` tail; retained `archive/*` evidence remains out of scope
