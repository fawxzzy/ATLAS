...
- ATLAS root self-lock sequencing has been resolved; the next pressure is the remaining export-first/manual-review external-smoke class plus later preview/unfurl and DiscordOS follow-on lanes
