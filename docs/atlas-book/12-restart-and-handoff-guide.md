...
- the exact next move after preserving that tranche is the later memory-path canonicalization carry `docs/memory/initiatives/initiative-mazer-d2-learning-scorer.json`; the broad untracked backlog remains out of scope
