...
- the exact next move after that classification is one bounded archive manifest-only inventory or sensitivity-split packet for `archive/fitness-source-reset`; bulk preserve, bulk stage, cleanup, or delete claims remain out of scope
