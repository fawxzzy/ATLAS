...
- the exact next move after preserving that tranche is later classification or preservation for the colder untracked `docs/ops/*` backlog; retained `archive/*` evidence remains out of scope
