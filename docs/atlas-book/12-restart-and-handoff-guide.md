...
- ATLAS root self-lock sequencing has been resolved; the next pressure is the remaining post-preservation Playbook external-smoke disposal/manual-review chain plus later preview/unfurl and DiscordOS follow-on lanes
