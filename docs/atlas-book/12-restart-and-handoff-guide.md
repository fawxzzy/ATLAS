...
- the exact next move is not another Cortex or docs-control-plane wave; it is one exact partial commit over the staged canonicalization-support tranche only
