...
- latest ATLAS-root immediate lane packet:
  - `_stack Readiness supervised execution-home concrete command-home first-implementation worker cluster reconciliation`
