...
- latest ATLAS-root immediate lane packet:
  - `_stack Readiness supervised execution-home command-home first-implementation worker cluster reconciliation`
