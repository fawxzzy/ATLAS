...
- latest ATLAS-root immediate lane packet:
  ...
  - superseding current-family update: the post-runtime-home-selection next-slice selector is durable through pass 566, the runtime-home choice contract is durable through pass 567, the runtime-home choice owner-facing home is durable through pass 568, the runtime-home choice support posture is durable through pass 569, the runtime-home choice first-implementation slice is durable through pass 570, the runtime-home choice worker handoff contract is durable through pass 571, the runtime-home choice readiness closeout is durable through pass 572, and the exact next package is now `_stack Readiness supervised execution-home runtime-home choice first-implementation worker packet 1`
