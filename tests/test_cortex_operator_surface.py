...
class CortexOperatorSurfaceTests(unittest.TestCase):
    ...
    def _base_context_payload(self) -> dict:
        ...
        payload["posture_snapshot"]["dirty_lanes"] = ["cortex-stack-consumer-default-routing-v0-1"]
    ...
    def test_validation_blocker_is_reflected_without_recomputing_lane(self) -> None:
        ...
        rail_state_payload["dirty_lanes"] = ["stabilize-stack-validation", "cortex-stack-consumer-default-routing-v0-1"]
