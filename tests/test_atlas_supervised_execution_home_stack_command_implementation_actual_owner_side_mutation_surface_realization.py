...
from tests.test_atlas_supervised_execution_home_stack_command_implementation_actual_owner_side_mutation_authority_class import (
    EXPECTED_KEYS as STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS_EXPECTED_KEYS,
    _base_result as _stack_command_implementation_actual_owner_side_mutation_authority_class_base_result,
)

EXPECTED_KEYS = STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS_EXPECTED_KEYS | {
...
def _base_result() -> dict[str, object]:
    return evaluate_supervised_execution_home_stack_command_implementation_actual_owner_side_mutation_authority_class(
        _stack_command_implementation_actual_owner_side_mutation_authority_class_base_result()
    )


class SupervisedExecutionHomeStackCommandImplementationActualOwnerSideMutationSurfaceRealizationTests(
    unittest.TestCase
):
    ...
    def test_admissible_result_reopens_one_contract_local_question(self) -> None:
        ...
        self.assertEqual(
            {
                "question": STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS_QUESTION_PROMPT,
                "candidate_ref": "repos/example/.worktrees/pilot-a",
                "authoritative_receipt_refs": list(
                    STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS_CONTRACT_RECEIPT_REFS
                ),
            },
        ...
        self.assertEqual(
            [],
            payload["stack_command_implementation_actual_owner_side_mutation_surface_realization_reasons"],
        )
        self.assertEqual(
    ...
    def test_non_admissible_upstream_status_fails_closed(self) -> None:
        bundle = _base_result()
        bundle["stack_command_implementation_actual_owner_side_mutation_authority_class_status"] = (
            "no_stack_command_implementation_actual_owner_side_mutation_authority_class"
        )
        bundle["stack_command_implementation_actual_owner_side_mutation_authority_class_question"] = None
        bundle["stack_command_implementation_actual_owner_side_mutation_authority_class_reasons"] = [
