...
from ops.atlas.supervised_execution_home_stack_command_implementation_owner_repo_mutation import (
    ...
    evaluate_supervised_execution_home_stack_command_implementation_owner_repo_mutation,
)
from tests.test_atlas_supervised_execution_home_stack_command_implementation_owner_repo_implementation_routing_card import (
    EXPECTED_KEYS as STACK_COMMAND_IMPLEMENTATION_OWNER_REPO_IMPLEMENTATION_ROUTING_CARD_EXPECTED_KEYS,
    _base_result as _stack_command_implementation_owner_repo_implementation_routing_card_base_result,
)

EXPECTED_KEYS = STACK_COMMAND_IMPLEMENTATION_OWNER_REPO_IMPLEMENTATION_ROUTING_CARD_EXPECTED_KEYS | {
...
def _base_result() -> dict[str, object]:
    return evaluate_supervised_execution_home_stack_command_implementation_owner_repo_implementation_routing_card(
        _stack_command_implementation_owner_repo_implementation_routing_card_base_result()
    )


class SupervisedExecutionHomeStackCommandImplementationOwnerRepoMutationTests(unittest.TestCase):
    def _evaluate(self, bundle: dict[str, object]) -> dict[str, object]:
        payload = evaluate_supervised_execution_home_stack_command_implementation_owner_repo_mutation(
            bundle
        )
    ...
    def test_admissible_result_reopens_one_contract_local_question(self) -> None:
        ...
        self.assertEqual(
            {
                "question": STACK_COMMAND_IMPLEMENTATION_OWNER_REPO_IMPLEMENTATION_ROUTING_CARD_QUESTION_PROMPT,
                "candidate_ref": "repos/example/.worktrees/pilot-a",
                "authoritative_receipt_refs": list(
                    STACK_COMMAND_IMPLEMENTATION_OWNER_REPO_IMPLEMENTATION_ROUTING_CARD_CONTRACT_RECEIPT_REFS
                ),
            },
        ...
        self.assertEqual(
            STACK_COMMAND_IMPLEMENTATION_OWNER_REPO_MUTATION_STATUS_ADMISSIBLE,
            payload["stack_command_implementation_owner_repo_mutation_status"],
        )
        self.assertEqual([], payload["stack_command_implementation_owner_repo_mutation_reasons"])
        self.assertEqual(
            {"question", "candidate_ref", "authoritative_receipt_refs"},
            set(payload["stack_command_implementation_owner_repo_mutation_question"].keys()),
        )
        self.assertEqual(
            QUESTION_PROMPT,
            payload["stack_command_implementation_owner_repo_mutation_question"]["question"],
        )
        self.assertEqual(
            "repos/example/.worktrees/pilot-a",
            payload["stack_command_implementation_owner_repo_mutation_question"]["candidate_ref"],
        )
        self.assertEqual(
            list(CONTRACT_RECEIPT_REFS),
            payload["stack_command_implementation_owner_repo_mutation_question"][
    ...
    def test_non_admissible_upstream_status_fails_closed(self) -> None:
        bundle = _base_result()
        bundle["stack_command_implementation_owner_repo_implementation_routing_card_status"] = (
            "no_stack_command_implementation_owner_repo_implementation_routing_card"
        )
        bundle["stack_command_implementation_owner_repo_implementation_routing_card_question"] = None
        bundle["stack_command_implementation_owner_repo_implementation_routing_card_reasons"] = [
        ...
        self.assertIsNone(payload["stack_command_implementation_owner_repo_mutation_question"])
        self.assertEqual(
            ["stack_command_implementation_owner_repo_implementation_routing_card_status_not_admissible"],
            payload["stack_command_implementation_owner_repo_mutation_reasons"],
        )
    ...
    def test_attempted_actual_mutation_or_exception_fail_closed(self) -> None:
        cases = (
            (
                "mutation_surface",
