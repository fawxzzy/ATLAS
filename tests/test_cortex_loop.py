...
class CortexLoopTests(unittest.TestCase):
    ...
    def test_priority_pivot_produces_cortex_runtime_run_result(self) -> None:
        ...
        self.assertEqual("cortex_stack_consumption_pilot", result.worker_plan.template_id)
        ...
        self.assertEqual("pilot-cortex-worker-prompt-stack-consumption-wave7", trace["selected_next_action_id"])
