...
class CortexLoopTests(unittest.TestCase):
    ...
    def test_priority_pivot_produces_cortex_runtime_run_result(self) -> None:
        ...
        self.assertEqual("cortex_worker_prompt_contract", result.worker_plan.template_id)
        ...
        self.assertEqual("promote-cortex-worker-prompt-contract-wave6", trace["selected_next_action_id"])
