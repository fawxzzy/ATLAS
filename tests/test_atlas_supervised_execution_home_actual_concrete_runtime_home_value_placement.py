...
from ops.atlas.supervised_execution_home_actual_concrete_runtime_home_choice import (
    ...
    CONTRACT_RECEIPT_REFS as ACTUAL_CONCRETE_RUNTIME_HOME_CHOICE_CONTRACT_RECEIPT_REFS,
    QUESTION_PROMPT as ACTUAL_CONCRETE_RUNTIME_HOME_CHOICE_QUESTION_PROMPT,
...
from ops.atlas.supervised_execution_home_actual_concrete_runtime_home_value import (
    ...
    evaluate_supervised_execution_home_actual_concrete_runtime_home_value,
)
from ops.atlas.supervised_execution_home_actual_concrete_runtime_home_value_choice import (
    ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CHOICE_STATUS_ADMISSIBLE,
    CONTRACT_RECEIPT_REFS as ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CHOICE_CONTRACT_RECEIPT_REFS,
    QUESTION_PROMPT as ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CHOICE_QUESTION_PROMPT,
    evaluate_supervised_execution_home_actual_concrete_runtime_home_value_choice,
)
from ops.atlas.supervised_execution_home_actual_concrete_runtime_home_value_placement import (
    ...
    QUESTION_PROMPT,
    evaluate_supervised_execution_home_actual_concrete_runtime_home_value_placement,
)
...
def _base_result() -> dict[str, object]:
    ...
    actual_concrete_runtime_home_choice_input = (
        evaluate_supervised_execution_home_concrete_runtime_home_choice(
            concrete_runtime_home_choice_input
        )
    )
    actual_concrete_runtime_home_value_choice_input = (
        evaluate_supervised_execution_home_actual_concrete_runtime_home_choice(
            actual_concrete_runtime_home_choice_input
        )
    )
    actual_concrete_runtime_home_value_input = (
        evaluate_supervised_execution_home_actual_concrete_runtime_home_value_choice(
            actual_concrete_runtime_home_value_choice_input
        )
    )
    return evaluate_supervised_execution_home_actual_concrete_runtime_home_value(
        actual_concrete_runtime_home_value_input
    )
...
class SupervisedExecutionHomeActualConcreteRuntimeHomeValuePlacementTests(
    unittest.TestCase
):
    def _evaluate(self, bundle: dict[str, object]) -> dict[str, object]:
        payload = evaluate_supervised_execution_home_actual_concrete_runtime_home_value_placement(
            bundle
        )
    ...
    def test_admissible_result_reopens_one_contract_local_question(self) -> None:
        ...
        self.assertEqual(
            ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CHOICE_STATUS_ADMISSIBLE,
            payload["actual_concrete_runtime_home_value_choice_status"],
        )
        self.assertEqual([], payload["actual_concrete_runtime_home_value_choice_reasons"])
        self.assertEqual(
            ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_STATUS_ADMISSIBLE,
            payload["actual_concrete_runtime_home_value_status"],
        )
        self.assertEqual([], payload["actual_concrete_runtime_home_value_reasons"])
        self.assertEqual(
            {
                "question": ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_QUESTION_PROMPT,
                "candidate_ref": "repos/example/.worktrees/pilot-a",
                "authoritative_receipt_refs": list(
                    ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CONTRACT_RECEIPT_REFS
                ),
            },
            payload["actual_concrete_runtime_home_value_question"],
        )
        self.assertEqual(
            ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_PLACEMENT_STATUS_ADMISSIBLE,
            payload["actual_concrete_runtime_home_value_placement_status"],
        )
        self.assertEqual([], payload["actual_concrete_runtime_home_value_placement_reasons"])
        self.assertEqual(
            {"question", "candidate_ref", "authoritative_receipt_refs"},
            set(payload["actual_concrete_runtime_home_value_placement_question"].keys()),
        )
        self.assertEqual(
            QUESTION_PROMPT,
            payload["actual_concrete_runtime_home_value_placement_question"]["question"],
        )
        self.assertEqual(
            "repos/example/.worktrees/pilot-a",
            payload["actual_concrete_runtime_home_value_placement_question"][
                "candidate_ref"
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            {
                "question": ACTUAL_CONCRETE_RUNTIME_HOME_CHOICE_QUESTION_PROMPT,
                "candidate_ref": "repos/example/.worktrees/pilot-a",
                "authoritative_receipt_refs": list(
                    ACTUAL_CONCRETE_RUNTIME_HOME_CHOICE_CONTRACT_RECEIPT_REFS
                ),
            },
        ...
        self.assertEqual(
            {
                "question": ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CHOICE_QUESTION_PROMPT,
                "candidate_ref": "repos/example/.worktrees/pilot-a",
                "authoritative_receipt_refs": list(
                    ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CHOICE_CONTRACT_RECEIPT_REFS
                ),
            },
            payload["actual_concrete_runtime_home_value_choice_question"],
        )

    def test_non_admissible_upstream_status_fails_closed(self) -> None:
        bundle = _base_result()
        bundle["actual_concrete_runtime_home_value_status"] = (
            "no_actual_concrete_runtime_home_value"
        )
        bundle["actual_concrete_runtime_home_value_question"] = None
        bundle["actual_concrete_runtime_home_value_reasons"] = [
        ...
        self.assertIsNone(payload["actual_concrete_runtime_home_value_placement_question"])
        self.assertEqual(
            ["actual_concrete_runtime_home_value_status_not_admissible"],
            payload["actual_concrete_runtime_home_value_placement_reasons"],
        )
            ...
            (
                "question_card_wrong_receipts",
                {
                    "actual_concrete_runtime_home_value_question": {
                        ...
                        "candidate_ref": "repos/example/.worktrees/pilot-a",
                        "authoritative_receipt_refs": list(
                            ACTUAL_CONCRETE_RUNTIME_HOME_VALUE_CONTRACT_RECEIPT_REFS[:-1]
                        ),
                    }
                },
                ["actual_concrete_runtime_home_value_question_not_explicit"],
    ...
    def test_attempted_placement_choice_runtime_authority_or_exception_fail_closed(
        self,
    ) -> None:
        cases = (
            (
                "actual_concrete_runtime_home_value_placement",
                "repos/_stack/runtime-home.json",
