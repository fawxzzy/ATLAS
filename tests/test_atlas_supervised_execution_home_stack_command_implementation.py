...
from ops.atlas.supervised_execution_home_actual_concrete_stack_command_implementation_surface_choice import (
    ...
    evaluate_supervised_execution_home_actual_concrete_stack_command_implementation_surface_choice,
)
from ops.atlas.supervised_execution_home_stack_command_implementation import (
    CONTRACT_RECEIPT_REFS,
    NO_STACK_COMMAND_IMPLEMENTATION,
    QUESTION_PROMPT,
    STACK_COMMAND_IMPLEMENTATION_STATUS_ADMISSIBLE,
    evaluate_supervised_execution_home_stack_command_implementation,
)
from tests.test_atlas_supervised_execution_home_actual_concrete_stack_command_implementation_surface_choice import (
    _base_result as _actual_implementation_surface_choice_base_result,
)
...
EXPECTED_KEYS = {
    ...
    "stack_command_implementation_status",
    "stack_command_implementation_question",
    "stack_command_implementation_reasons",
}


def _base_result() -> dict[str, object]:
    return evaluate_supervised_execution_home_actual_concrete_stack_command_implementation_surface_choice(
        _actual_implementation_surface_choice_base_result()
    )


class SupervisedExecutionHomeStackCommandImplementationTests(unittest.TestCase):
    def _evaluate(self, bundle: dict[str, object]) -> dict[str, object]:
        payload = evaluate_supervised_execution_home_stack_command_implementation(bundle)
    ...
    def test_admissible_result_reopens_one_contract_local_question(self) -> None:
        ...
        self.assertEqual(
            ACTUAL_CONCRETE_STACK_COMMAND_IMPLEMENTATION_SURFACE_CHOICE_STATUS_ADMISSIBLE,
            payload["actual_concrete_stack_command_implementation_surface_choice_status"],
        )
        self.assertEqual(
            {
                "question": ACTUAL_CONCRETE_STACK_COMMAND_IMPLEMENTATION_SURFACE_CHOICE_QUESTION_PROMPT,
                "candidate_ref": "repos/example/.worktrees/pilot-a",
                "authoritative_receipt_refs": list(
                    ACTUAL_CONCRETE_STACK_COMMAND_IMPLEMENTATION_SURFACE_CHOICE_CONTRACT_RECEIPT_REFS
                ),
            },
            payload["actual_concrete_stack_command_implementation_surface_choice_question"],
        )
        self.assertEqual(
            STACK_COMMAND_IMPLEMENTATION_STATUS_ADMISSIBLE,
            payload["stack_command_implementation_status"],
        )
        self.assertEqual([], payload["stack_command_implementation_reasons"])
        self.assertEqual(
            {"question", "candidate_ref", "authoritative_receipt_refs"},
            set(payload["stack_command_implementation_question"].keys()),
        )
        self.assertEqual(
            QUESTION_PROMPT,
            payload["stack_command_implementation_question"]["question"],
        )
        self.assertEqual(
            "repos/example/.worktrees/pilot-a",
            payload["stack_command_implementation_question"]["candidate_ref"],
        )
        self.assertEqual(
            list(CONTRACT_RECEIPT_REFS),
            payload["stack_command_implementation_question"]["authoritative_receipt_refs"],
        )

    def test_non_admissible_upstream_status_fails_closed(self) -> None:
        bundle = _base_result()
        bundle["actual_concrete_stack_command_implementation_surface_choice_status"] = (
            "no_actual_concrete_stack_command_implementation_surface_choice"
        )
        bundle["actual_concrete_stack_command_implementation_surface_choice_question"] = None
        bundle["actual_concrete_stack_command_implementation_surface_choice_reasons"] = [
            "concrete_stack_command_implementation_surface_choice_status_not_admissible"
        ]
        ...
        self.assertIsNone(payload["stack_command_implementation_question"])
        self.assertEqual(
            ["actual_concrete_stack_command_implementation_surface_choice_status_not_admissible"],
            payload["stack_command_implementation_reasons"],
        )
