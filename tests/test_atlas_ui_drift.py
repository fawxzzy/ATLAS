...
class AtlasUiDriftTests(unittest.TestCase):
    ...
    def test_default_expected_observation_set_covers_expanded_history_session_workout_card_settings_detail_support_chooser_auth_entry_and_curated_routes(self) -> None:
        ...
        self.assertEqual(55, report["summary"]["expected_capture_count"])
