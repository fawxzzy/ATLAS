...
from tests.test_atlas_supervised_execution_home_concrete_stack_command_implementation_surface_choice import (
    _base_result as _implementation_surface_choice_base_result,
)
...
def _base_result() -> dict[str, object]:
    return evaluate_supervised_execution_home_concrete_stack_command_implementation_surface_choice(
        _implementation_surface_choice_base_result()
    )


class SupervisedExecutionHomeActualConcreteStackCommandImplementationSurfaceChoiceTests(
    unittest.TestCase
):
    ...
    def test_admissible_result_reopens_one_contract_local_question(self) -> None:
        ...
        self.assertEqual(
            {
                "question": CONCRETE_STACK_COMMAND_IMPLEMENTATION_SURFACE_CHOICE_QUESTION_PROMPT,
                "candidate_ref": "repos/example/.worktrees/pilot-a",
                "authoritative_receipt_refs": list(
                    CONCRETE_STACK_COMMAND_IMPLEMENTATION_SURFACE_CHOICE_CONTRACT_RECEIPT_REFS
                ),
            },
        ...
        self.assertEqual(
            [],
            payload["actual_concrete_stack_command_implementation_surface_choice_reasons"],
        )
        self.assertEqual(
    ...
    def test_non_admissible_upstream_status_fails_closed(self) -> None:
        bundle = _base_result()
        bundle["concrete_stack_command_implementation_surface_choice_status"] = (
            "no_concrete_stack_command_implementation_surface_choice"
        )
        bundle["concrete_stack_command_implementation_surface_choice_question"] = None
        bundle["concrete_stack_command_implementation_surface_choice_reasons"] = [
    ...
    def test_attempted_actual_choice_runtime_authority_or_exception_fail_closed(
        self,
    ) -> None:
        cases = (
            (
