...
class CortexContextAssemblerTests(unittest.TestCase):
    ...
    def _base_rail_state_payload(self) -> dict:
        ...
        payload["seeded_rail_state"]["next_action"]["action_id"] = "promote-cortex-worker-prompt-contract-wave6"
    ...
    def test_clean_posture_assembles_seeded_lane_packet(self) -> None:
        ...
        self.assertEqual("context-promote-cortex-worker-prompt-contract-wave6", payload["packet_id"])
        self.assertEqual("promote-cortex-worker-prompt-contract-wave6", payload["task_frame"]["lane_id"])
    ...
    def test_validation_blocker_switches_immediate_lane_and_preserves_deferred_lane(self) -> None:
        ...
        self.assertEqual("promote-cortex-worker-prompt-contract-wave6", payload["deferred_lane"]["lane_id"])
