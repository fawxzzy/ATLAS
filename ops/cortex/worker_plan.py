...
CORTEX_RECEIPT_INTERPRETATION_STACK_CONSUMPTION_CONTRACT_TEMPLATE = WorkerPlanTemplate(
    template_id="cortex_receipt_interpretation_stack_consumption_contract",
    objective=(
        "Promote bounded _stack consumption of Cortex receipt interpretation artifacts without enabling dispatch, "
        "execution, approval, final receipt authority, owner-truth mutation, Lifeline-truth mutation, or transcript scraping."
    ),
    implementation_plan=(
        "Add one bounded receipt-interpretation stack-consumption artifact that consumes explicit artifact refs only.",
        "Verify receipt interpretation, advisory handoff, stack-consumption pilot, and validation inputs stay ready while all authority-widening guards remain false.",
        "Regenerate deterministic Cortex artifacts without turning stack consumption into dispatch, execution, approval, final receipt authority, owner-truth mutation, Lifeline-truth mutation, or transcript scraping.",
    ),
    default_files_to_modify=(
        "ops/cortex/receipt_interpretation_stack_consumption.py",
        "ops/cortex/worker_plan.py",
        "schemas/atlas.cortex.receipt-interpretation-stack-consumption.v1.json",
    ...
    documentation_summary=(
        "_stack may consume Cortex receipt interpretation artifacts through explicit artifact refs only; that consumption remains advisory and does not grant dispatch, execution, approval, final-receipt, owner-truth, Lifeline-truth, or transcript authority."
    ),
    default_verification_steps=(
        "python -m unittest tests.test_cortex_receipt_interpretation_stack_consumption tests.test_cortex_worker_prompt tests.test_cortex_worker_plan -v",
    ...
    default_failure_modes_to_avoid=(
        ...
        "Do not approve work.",
        "Do not issue final receipts.",
        "Do not mutate Lifeline truth.",
        "Do not mutate owner truth.",
