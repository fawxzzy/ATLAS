...
PACKET_REGISTRY: dict[str, PacketDescriptor] = {
    ...
    "Sandbox Simulation Readiness": PacketDescriptor(
        packet="Sandbox Simulation Readiness local-only first validator-candidate-output shape contract freeze",
        basis_receipt_ref=(
            "docs/ops/"
            "SANDBOX-SIMULATION-READINESS-LOCAL-ONLY-FIRST-VALIDATOR-COMPARISON-"
            "BOUNDARY-CONTRACT-FREEZE-2026-06-27.md"
        ),
        mode="root-owned docs-only validator-candidate-output follow-on",
        scope=(
            "freeze the future candidate-output shape that a local-only validator may project into the admitted "
            "comparison boundary without admitting validator execution, runner behavior, "
