...
from ops.atlas.supervised_execution_home_stack_command_implementation_actual_owner_side_mutation_surface import (
    ...
    PASSTHROUGH_FIELDS as STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_SURFACE_PASSTHROUGH_FIELDS,
...
STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS_STATUS_ADMISSIBLE = (
    "stack_command_implementation_actual_owner_side_mutation_authority_class_admissible"
)
NO_STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS = (
    "no_stack_command_implementation_actual_owner_side_mutation_authority_class"
)
QUESTION_PROMPT = (
    "Which actual owner-side mutation authority class contract, if any, may "
    "any later admitted surface define for the already-admitted _stack command "
    "implementation actual owner-side mutation surface seam for `stack "
    "supervised-execution-home` without defining one actual owner-side "
    "mutation surface now, one actual owner-side mutation authority class now, "
...
CONTRACT_RECEIPT_REFS = (
    "docs/ops/_STACK-READINESS-SUPERVISED-EXECUTION-HOME-STACK-COMMAND-IMPLEMENTATION-ACTUAL-OWNER-SIDE-MUTATION-AUTHORITY-CLASS-CONTRACT-FREEZE-PASS-719-2026-06-26.md",
    "docs/ops/_STACK-READINESS-SUPERVISED-EXECUTION-HOME-STACK-COMMAND-IMPLEMENTATION-ACTUAL-OWNER-SIDE-MUTATION-AUTHORITY-CLASS-OWNER-SURFACE-ADMISSION-PASS-720-2026-06-26.md",
    "docs/ops/_STACK-READINESS-SUPERVISED-EXECUTION-HOME-STACK-COMMAND-IMPLEMENTATION-ACTUAL-OWNER-SIDE-MUTATION-AUTHORITY-CLASS-SUPPORTING-LANE-ADMISSION-PASS-721-2026-06-26.md",
    "docs/ops/_STACK-READINESS-SUPERVISED-EXECUTION-HOME-STACK-COMMAND-IMPLEMENTATION-ACTUAL-OWNER-SIDE-MUTATION-AUTHORITY-CLASS-FIRST-IMPLEMENTATION-ADMISSION-PASS-722-2026-06-26.md",
)
...
PASSTHROUGH_FIELDS = (
    *STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_SURFACE_PASSTHROUGH_FIELDS,
    "stack_command_implementation_actual_owner_side_mutation_surface_status",
...
def _question_card_is_explicit(value: Any, candidate_path: str) -> bool:
    ...
    return (
        ...
        == STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_SURFACE_QUESTION_PROMPT
        ...
        == list(STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_SURFACE_CONTRACT_RECEIPT_REFS)
    )
...
def _selection_reasons(
    ...
    if (
        _normalized_text(
            bundle.get("stack_command_implementation_actual_owner_side_mutation_surface_status")
        )
        != STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_SURFACE_STATUS_ADMISSIBLE
    ):
        return ["stack_command_implementation_actual_owner_side_mutation_surface_status_not_admissible"]

    reasons: list[str] = []
    if not _question_card_is_explicit(
        bundle.get("stack_command_implementation_actual_owner_side_mutation_surface_question"),
        candidate_path,
    ):
        reasons.append(
    ...
    if _normalized_string_list(
        bundle.get("stack_command_implementation_actual_owner_side_mutation_surface_reasons")
    ):
        reasons.append("stack_command_implementation_actual_owner_side_mutation_surface_reasons_present")
...
def evaluate_supervised_execution_home_stack_command_implementation_actual_owner_side_mutation_authority_class(
    bundle: Mapping[str, Any],
) -> dict[str, Any]:
    ...
    result["stack_command_implementation_actual_owner_side_mutation_authority_class_status"] = (
        STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS_STATUS_ADMISSIBLE
        if not reasons
        else NO_STACK_COMMAND_IMPLEMENTATION_ACTUAL_OWNER_SIDE_MUTATION_AUTHORITY_CLASS
    )
    result["stack_command_implementation_actual_owner_side_mutation_authority_class_question"] = (
        _question_card(candidate_path) if not reasons else None
    )
    result["stack_command_implementation_actual_owner_side_mutation_authority_class_reasons"] = reasons
    return result
