...
export const CONTRACT = Object.freeze({
  ...
  currentPreimageSha256: '71c18996c44cbbd713046359f78241622adfa25628a2c386655195fe3960b747',
...
const SQL_TOKENS = Object.freeze({
  'preflight.sql': ['data_api', 'rls', 'acl', 'auth.users', '114', '13', '16', '1884', 'mazer_username_handle_key'],
  ...
  'postverify.sql': ['data_api', 'rls', 'acl', '117', '19', '13', '16', '1884', 'receipt_conservation', 'username_origin', 'mazer-'],
...
export function validatePrivateSource(raw) {
  ...
  if (counts.profiles !== 13 || counts.player !== 16 || counts.ai !== 16 || counts.receipts !== 1884) throw new Error('APP_DENOMINATOR_DRIFT');
  ...
  if (actionClassified.desired_counts.profiles !== 13 || actionClassified.desired_counts.player !== 16 || actionClassified.desired_counts.ai !== 16 || actionClassified.desired_counts.receipts !== 1884) throw new Error('ACTION_APP_DENOMINATOR_DRIFT');
