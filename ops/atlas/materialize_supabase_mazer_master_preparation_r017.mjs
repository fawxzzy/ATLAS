...
export const CONTRACT = Object.freeze({
  ...
  currentPreimageSha256: '1384da39e995fb8f0c2f0d2e8aea5576dd75b0d8789b8445975cfb9e1f886d67',
...
const SQL_TOKENS = Object.freeze({
  ...
  'postverify.sql': ['data_api', 'rls', 'acl', '117', '19', '13', '16', '1885', 'receipt_conservation', 'username_origin', 'mazer-'],
...
export function validatePrivateSource(raw) {
  ...
  if (counts.profiles !== 13 || counts.player !== 16 || counts.ai !== 16 || counts.receipts !== 1885) throw new Error('APP_DENOMINATOR_DRIFT');
  ...
  if (actionClassified.desired_counts.profiles !== 13 || actionClassified.desired_counts.player !== 16 || actionClassified.desired_counts.ai !== 16 || actionClassified.desired_counts.receipts !== 1885) throw new Error('ACTION_APP_DENOMINATOR_DRIFT');
