...
for (const token of [
  ...
  'EVIDENCE_DIGEST_DRIFT','SEALED_AUTH_DENOMINATOR_DRIFT','IDENTITY_DENOMINATOR_DRIFT','NORMALIZED_EMAIL_DUPLICATE',
  'TOPOLOGY_EVIDENCE_DRIFT',
  ...
  'CATALOG_PREIMAGE_ALREADY_MIGRATED','CATALOG_PREIMAGE_CONSTRAINT_MISSING','R017_BOUND_AUTH_USER_CARDINALITY_DRIFT',
  'R017_BOUND_AUTH_USER_EMAIL_DRIFT','R017_BOUND_AUTH_IDENTITY_OWNER_DRIFT','R017_BOUND_AUTH_IDENTITY_PROVIDER_ID_DRIFT',
  'R017_BOUND_AUTH_IDENTITY_SUBJECT_DRIFT','R017_BOUND_AUTH_IDENTITY_EMAIL_DRIFT','R017_AUTH_PREIMAGE_CARDINALITY_DRIFT',
  'R017_BOUND_AUTH_USER_MUTATION_DRIFT','R017_BOUND_AUTH_IDENTITY_MUTATION_DRIFT',
  ...
  'ACL_OBSERVATION_KEYS','ACL_OBSERVATION_TIMESTAMP_DRIFT','ACL_PREIMAGE_KEYS','normalizePsqlCommandSql','ON_ERROR_STOP=1','RESET_IDENTITY_RECEIPT_BINDING_DRIFT','RESET_MASTER_ROW_DRIFT'
...
requireToken(materializer, '93e9bb87bac2d658d4f5e9f058f5b52f5a5bab32f109b4a67e617c3f93008a0a', 'TOPOLOGY_EVIDENCE_HASH_MISSING');
