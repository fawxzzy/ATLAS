...
for (const token of [
  ...
  '1384da39e995fb8f0c2f0d2e8aea5576dd75b0d8789b8445975cfb9e1f886d67','9e39b18246699405fc1651f64995a8526d5750e5bebcc85e880f4f295b12a308','54dee535bac3e02b7058fe644cd44af115cc3746ff1e40390521992dccd14971',
...
for (const token of ['AUTH_TOPOLOGY_MANIFEST_DRIFT','auth_counts.binds -ne 14','auth_counts.final_edges -ne 19','auth_counts.retained_edges -ne 2','final_identity_edges = 19','profiles = 13','player = 16','ai = 16','receipts = 1885']) requireText(source.host, token, `HOST_TOPOLOGY_VERIFICATION_MISSING:${token}`);
