...
const sqlTokens = {
  ...
  'postverify.sql': ['begin;','data_api','rls','acl','117','19','13','16','1884','receipt_conservation','username_origin','mazer-'],
...
for (const token of [
  ...
  '19','117','1884','7/6/32/D','PGP_SYM_ENCRYPT_AES256','MASTER_DOMINATES_NO_OVERRIDE','PLAYER_RESET_DOMINANCE_DRIFT',
