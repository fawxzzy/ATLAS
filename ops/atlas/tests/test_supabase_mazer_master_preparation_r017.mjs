...
const sqlTokens = {
  ...
  'reset-era-apply.sql': ['begin;','whole_row_override','8/7/36/d','39/108/161/s','pgp_sym_encrypt','player_reset_disposition','vault.create_secret','rollback_bound_username_key'],
  'postverify.sql': ['begin;','data_api','rls','acl','117','19','13','16','1886','receipt_conservation','username_origin','mazer-'],
...
for (const token of [
  ...
  '19','117','1886','8/7/36/D','PGP_SYM_ENCRYPT_AES256','MASTER_DOMINATES_NO_OVERRIDE','PLAYER_RESET_DOMINANCE_DRIFT',
