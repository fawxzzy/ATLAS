...
def evaluate_supervised_execution_home_concrete_stack_command_implementation_surface(
    bundle: Mapping[str, Any],
) -> dict[str, Any]:
    ...
    return {
        ...
        "concrete_stack_command_implementation_surface_selection_status": (
            CONCRETE_STACK_COMMAND_IMPLEMENTATION_SURFACE_SELECTION_STATUS_ADMISSIBLE
            if not reasons
            else NO_CONCRETE_STACK_COMMAND_IMPLEMENTATION_SURFACE_SELECTION
        ),
        "concrete_stack_command_implementation_surface_selection_question": (
            _question_card(candidate_path) if not reasons else None
        ),
        "concrete_stack_command_implementation_surface_selection_reasons": reasons,
    }
