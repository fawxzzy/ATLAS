...
Atlas root owns schema semantics and validation behavior. Owner repositories produce or consume governed artifacts through this package and do not maintain validator copies. Clusters 1 and 2 prove `6/11` adoption for ComponentManifest, JobEnvelope, ContextPacket, ApprovalRecord, EvidenceBundle, and ExecutionReceipt through governed producer and independent consumer evidence. The five remaining families are CardRecord, WorkerLease, BoardEvent, MarkerEvidence, and KnowledgeCandidate. See [the Cluster 1 adoption receipt](../../docs/ops/ATLAS-CONTRACTS-V2-CLUSTER-1-ADOPTION-2026-07-13.md) and [the Cluster 2 adoption receipt](../../docs/ops/ATLAS-CONTRACTS-V2-CLUSTER-2-ADOPTION-2026-07-13.md).
